...
pub async fn handle_generate(
    ...
    for attempt in 0..max_attempts {
        ...
        // Extract tools list for networking probe (Gemini style might be nested)
        ...
        // Critical: Force account rotation during retry attempts (attempt > 0)
        ...
        // Pass session_id to wrap_request for signature injection
        ...
        // Inject Anthropic Beta Headers for Claude models
        ...
        if status.is_success() {
            ...
            if is_stream {
                ...
                // Implement peek logic for Gemini stream to prevent 0-token 200 OK
                            ...
                            if let Ok(line_str) = std::str::from_utf8(&line_raw) {
                                ...
                                if line.starts_with("data: ") {
                                    ...
                                    match serde_json::from_str::<Value>(json_part) {
                                        Ok(mut json) => {
                                            // Extract thoughtSignature from stream
                                            ...
                                            // Inject Tool ID into Stream Response
            ...
            // Inject Tool ID into Non-streaming Response
            crate::proxy::mappers::gemini::wrapper::inject_ids_to_response(&mut gemini_resp, &mapped_model);

            // Extract thoughtSignature from non-streaming response
        ...
        //  Handle 400 error (Thinking signature invalidated)
        if status_code == 400 
                ...
                || error_text.contains("Corrupted thought signature"))
        {
            ...
            // Append repair prompt to the last content of the request body
        ...
        // HTTP exceptions like 404 due to model config or path errors are reported directly, no invalid rotation performed
