...
pub(crate) use config_pool::{
    ...
    admin_get_config, admin_get_proxy_pool_config, admin_save_config,
    admin_trigger_proxy_health_check, admin_unbind_account_proxy,
};
pub(crate) use logs::{
...
pub(crate) use service_control::{
    ...
    admin_get_proxy_compliance_debug, admin_get_proxy_session_bindings, admin_get_proxy_status,
    admin_get_proxy_sticky_config, admin_get_version_routes, admin_set_preferred_account,
    admin_set_proxy_monitor_enabled, admin_start_proxy_service, admin_stop_proxy_service,
    admin_update_model_mapping, admin_update_proxy_compliance, admin_update_proxy_sticky_config,
};
