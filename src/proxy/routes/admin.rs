...
pub fn build_admin_routes(state: AppState) -> Router<AppState> {
    add_legacy_stats_alias_routes(
        ...
        .route(
            "/accounts",
            get(admin::admin_list_accounts)
                .post(admin::admin_add_account),
        )
        .route(
            "/accounts/current",
            get(admin::admin_get_current_account),
        )
        .route(
            "/accounts/switch",
            post(admin::admin_switch_account),
        )
        .route(
            "/accounts/refresh",
            post(admin::admin_refresh_all_quotas),
        )
        .route(
            "/accounts/:accountId",
            delete(admin::admin_delete_account),
        )
        .route(
        ...
        .route(
            "/accounts/import/v1",
            post(admin::admin_import_v1_accounts),
        )
        .route(
            "/accounts/import/db",
            post(admin::admin_import_from_db),
        )
        .route(
        ...
        .route(
            "/accounts/sync/db",
            post(admin::admin_sync_account_from_db),
        )
        .route(
            "/config",
        ...
        .route(
            "/proxy/cli/status",
            post(admin::admin_get_cli_sync_status),
        )
        .route(
            "/proxy/cli/sync",
            post(admin::admin_execute_cli_sync),
        )
        .route(
            "/proxy/cli/restore",
            post(admin::admin_execute_cli_restore),
        )
        .route(
            "/proxy/cli/config",
        ...
        .route(
            "/proxy/status",
            get(admin::admin_get_proxy_status),
        )
        .route(
            "/proxy/pool/config",
        ...
        .route(
            "/proxy/pool/bind",
            post(admin::admin_bind_account_proxy),
        )
        .route(
            "/proxy/pool/unbind",
        ...
        .route(
            "/proxy/start",
            post(admin::admin_start_proxy_service),
        )
        .route(
            "/proxy/stop",
            post(admin::admin_stop_proxy_service),
        )
        .route(
            "/proxy/mapping",
            post(admin::admin_update_model_mapping),
        )
        .route(
        ...
        .route(
            ...
            get(admin::admin_get_preferred_account)
                .post(admin::admin_set_preferred_account),
        )
        .route(
        ...
        .route(
            "/zai/models/fetch",
            post(admin::admin_fetch_zai_models),
        )
        .route(
        ...
        .route(
            "/system/open-folder",
            post(admin::admin_open_folder),
        )
        .route(
            "/proxy/stats",
            get(admin::admin_get_proxy_stats),
        )
        .route(
            "/logs",
            get(admin::admin_get_proxy_logs_filtered),
        )
        .route(
            "/logs/count",
        ...
        .route(
            "/logs/clear",
            post(admin::admin_clear_proxy_logs),
        )
        .route(
            "/logs/:logId",
            get(admin::admin_get_proxy_log_detail),
        )
        .route(
            "/debug/enable",
            post(admin::admin_enable_debug_console),
        )
        .route(
            "/debug/disable",
            post(admin::admin_disable_debug_console),
        )
        .route(
            "/debug/enabled",
            get(admin::admin_is_debug_console_enabled),
        )
        .route(
            "/debug/logs",
            get(admin::admin_get_debug_console_logs),
        )
        .route(
            "/debug/logs/clear",
        ...
        .route(
            "/stats/token/clear",
            post(admin::admin_clear_token_stats),
        )
        .route(
            "/stats/token/hourly",
        ...
        .route(
            ...
            post(admin::admin_delete_accounts),
        )
        .route(
            "/accounts/export",
            post(admin::admin_export_accounts),
        )
        .route(
            "/accounts/reorder",
            post(admin::admin_reorder_accounts),
        )
        .route(
        ...
        .route(
            "/system/data-dir",
            get(admin::admin_get_data_dir_path),
        )
        .route(
        ...
        .route(
            "/security/logs",
            get(admin::admin_get_ip_access_logs),
        )
        .route(
            "/security/logs/clear",
        ...
        .route(
            "/security/config",
            get(admin::admin_get_security_config)
                .post(admin::admin_update_security_config),
        )
        .route(
            "/user-tokens",
            get(admin::admin_list_user_tokens)
                .post(admin::admin_create_user_token),
        )
        .route(
            "/user-tokens/summary",
        ...
        .route(
            "/user-tokens/:id",
            delete(admin::admin_delete_user_token)
                .patch(admin::admin_update_user_token),
        )
        .route(
            "/auth/url",
            get(admin::admin_prepare_oauth_url_web),
        ),
    )
